  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-2"><label class="form-label">Prefix</label><input class="form-control" id="prefix" maxlength="2"></div>
...
tblBody.addEventListener('click', async (e)=>{
  ...
  if(act==='del'){
    const confirmed = await odConfirm('Delete this section?', 'Delete Section');
    if(!confirmed) return;
